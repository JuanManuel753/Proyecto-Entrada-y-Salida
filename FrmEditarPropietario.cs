    ...
    public partial class FrmEditarPropietario : Form
    {
        ...
        private void Dgv_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                TxtRol.Text = Dgv.CurrentRow.Cells[3].Value.ToString();
        ...
        private void BtnGuardar_Click(object sender, EventArgs e)
        {
            ...
            conexion.Open();
            //Crear una instancia de la clase SqlCommand
            SqlCommand cmd = new SqlCommand("Pa_Editar_Propietario", conexion);
            ...
            rpta = MessageBox.Show("¿Desea Guardar  El Propietario Editado?", "EDITAR", MessageBoxButtons.OKCancel, MessageBoxIcon.Information);
